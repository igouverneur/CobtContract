...
contract COBT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string constant private _name = "Call Of Blockchain Token";
    ...
    uint256 public maxBuy = 3 * 10 ** 18;
    uint256 public hardCap = 1000 * 10 ** 18;
    uint256 public totalBuy;
    uint256 public tokensForPresale = 24000000;

    address payable public marketingWalletAddress = payable(0xB0e8B7825964F06d1047A4b7b9d35010968d0850); 
    address payable public developmentWalletAddress = payable(0x3Bd6657A5F7e4FD6731b8A6438332b7d14db9609); 
    ...
    constructor () {
        ...
        pancakeswapPair = IPancakeswapV2Factory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73)
            .createPair(address(this), 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    function buyInPresale() public payable {
        require(isPresale, "Presale not started yet or ended");
